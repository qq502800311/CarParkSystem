		...
		<div class="row-fluid sortable">		
			<div class="box span12">
				...
				<div class="box-header" data-original-title>
					<h2><i class="halflings-icon white user"></i><span class="break"></span>收支明细</h2>
<!-- 					<div class="box-icon"> -->
...
<!-- 					</div> -->
				...
				<div class="box-content" style="display: block;">		
					...
					<form id="receipt_from" method="post">
						<!-- start: box-工具栏 -->
<!-- 						<div class="row-fluid"> -->
							<!-- start: box-页数 -->
<!-- 							<div class="span6"> -->
...
<!-- 								<div id="DataTables_Table_0_filter"> -->
									...
									<span>时间开始： <input name="starttime_moneydetail" type="text" oninput="search()" aria-controls="DataTables_Table_0"></span>
									<span>时间结束：<input  name="endtime_moneydetail" type="text" oninput="search()" aria-controls="DataTables_Table_0"></span>
...
<script type="text/javascript" src="js/zlbjs/receiptpayment.js"></script>
</html>