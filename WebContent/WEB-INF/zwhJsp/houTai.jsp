...
<!-- 						<li><a href="emp/pageEmpManage.action" target="view_window"><i class="icon-align-justify"></i><span class="hidden-tablet"> 人员管理</span></a></li> -->
...
// 			};
			...
			<!-- start: Content -->
<!-- 			<div id="content" class="span11" style="min-height: 885px;"> -->
			
<!-------------------------------------------- iframe部分开始 ----------------------------------------------->			
<!-- 				<iframe id="if1" name="view_window" width=100% height=100%></iframe> -->
<!-------------------------------------------- iframe部分结束 ----------------------------------------------->	
